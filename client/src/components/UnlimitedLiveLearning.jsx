...
function UnlimitedLiveLearning() {
    return (
        <div className="w-[90%] mt-10 m-auto flex py-4 px-6">
            <div className="flex flex-col gap-5 w-[50%]">
                <h1 className="text-5xl text-[#0074e9] font-bold">Unlimited LIVE Learning</h1>
                <div className="mt-6">
            ...
            <div className="w-[50%] m-auto mb-5 h-auto">
