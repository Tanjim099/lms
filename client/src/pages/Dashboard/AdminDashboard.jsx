...
import { getPaymentRocord } from "../../redux/slices/RazorpaySlice";
    ...
    useEffect(() => {
        (
            async () => {
                ...
                await dispatch(getPaymentRocord())
            }
        )()
    }, [])
    return (
                ...
                <div className="grid grid-cols-2 gap-5 m-auto mx-10">
                    <div className="flex flex-col items-center gap-10 p-5 shadow-lg rounded-md">
                        ...
                        <div className="grid grid-cols-2 gap-5">
                            <div className="flex items-cente justify-between p-5 gap-5 rounded-md">
                    ...
                    <div className="flex flex-col items-center gap-10 p-5 shadow-lg rounded-md">
                        ...
                        <div className="grid grid-cols-2 gap-5">
                            ...
                            <div className="flex items-cente justify-between p-5 gap-5 rounded-md">
                                <div className="flex flex-col items-center">
                                    <p className="font-semibold">Totsl Revenue</p>
                ...
                <div className="mx-[10%] w-[80%] self-center flex flex-col items-center justify-center gap-10 mb-10">
                    <div className="flex w-full items-center justify-between">
                        ...
                        <button
                            ...
                            className="w-fit bg-yellow-500 hover:bg-yellow-600 transition-all ease-in-out duration-300 rounded-md py-2 px-4 font-semibold text-xl"
                        >
                            Create new course
                        </button>
                    </div>
                    <table className="table overflow-x-scroll text-white border-none">
                        ...
                        <tbody>
                            {myCourses?.map((course, idx) => {
                                return (
                                    <tr key={course._id} className="border-none">
                                        <td>{idx + 1}</td>
                                        <td>
